...
function myFunction(){
  ...
  function myFunction2(){
    ...
    if (answerTwo === "The times 03/Jan/2009 Chancellor on brink of second bailout for banks") { 
      ...
      $("#result2").html("</br> JOIN OUR DISCORD USING THE LINK BELOW:</br> <a>https://www.discord.com</a>");
      $("#result2 a").attr("href","https://www.discord.com");
